...
function App3() {
  ...
  const [rongK2, setRongK2] = useState(0.6);
  ...
  const settingDay2 = (day2) => {
    ...
    day2.position.x = depth + DDTBia + truHaoGoc;
  ...
  const settingBia4 = (bia4) => {
    ...
    bia4.position.x = depth + truHaoGoc + rongK2;
  ...
  const settingChanTruoc2 = (cTruoc2) => {
    cTruoc2.position.z = (rongK1 - depth + luiChan) * -1;
    cTruoc2.position.x = depth + DDTBia + truHaoGoc;
  ...
  const settingNepTruoc1 = (nepTruoc1) => {
    ...
    nepTruoc1.position.x = depth - DDTXTruoc;
    nepTruoc1.position.y = height - caoXTruoc;

    const lenZ = rongK1 - 2 * DDTBia - truHaoGoc;
  ...
  const settingNepTruoc3 = (nepTruoc3) => {
    nepTruoc3.position.z = (rongK1 - depth) * -1;
    nepTruoc3.position.x = depth + DDTBia + truHaoGoc + DDTBia;
  ...
  const settingNepTruoc4 = (nepTruoc4) => {
    nepTruoc4.position.z = (rongK1 - depth + DDTXTruoc) * -1;
    nepTruoc4.position.x = depth + DDTBia + truHaoGoc + DDTBia;
  ...
  const settingNepSau2 = (nepSau2) => {
    nepSau2.position.z = (rongK1 - DDTHau - DDTXSau) * -1;
    nepSau2.position.x = depth + DDTBia + truHaoGoc + DDTBia;
  ...
  const settingBa1 = (ba1) => {
    ba1.position.z = (rongK1 - depth - DDTBia) * -1;
  ...
  const settingMatCoDinh = (mcd) => {
    mcd.position.z = (rongK1 - depth - DDTBia - truHaoGoc) * -1;
  ...
  const settingXan1 = (xan1) => {
    xan1.position.z = (rongK1 - depth - DDTBia - truHaoGoc - 0.008) * -1;
  ...
  const settingXan2 = (xan2) => {
    xan2.position.z = (rongK1 - depth - DDTBia - truHaoGoc - 0.008) * -1;
