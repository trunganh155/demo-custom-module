...
function App2() {
  ...
  const settingDay1 = (day1) => {
    ...
    let boundingBoxNoc = new THREE.Box3().setFromObject(day1);
    const sizeNoc = new THREE.Vector3();
    boundingBoxNoc.getSize(sizeNoc);

    day1.scale.x = lenX / sizeNoc.x;
    day1.scale.y = lenY / sizeNoc.y;
    day1.scale.z = lenZ / sizeNoc.z;
  };
