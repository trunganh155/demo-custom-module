...
function App3() {
  ...
  const settingDay1_1 = (day1_1) => {
    ...
    day1_1.position.x = dayCot + DDTBia;
  ...
  const settingDay1_2 = (day1_2) => {
    day1_2.position.z = (rongCot + DDTBia) * -1;
    day1_2.position.x = truHaoGoc + DDTBia;
  ...
  const settingDay2 = (day2) => {
    day2.position.z = (depth + 2 * DDTBia + truHaoGoc) * -1;
  ...
  const settingNoc1_1 = (noc1_1) => {
    noc1_1.position.z = DDTHau * -1;
    noc1_1.position.x = dayCot + DDTBia;
    noc1_1.position.y = height - DDTBia;

    const lenZ = depth - DDTHau;
    const lenX = rongK1 - dayCot - 2 * DDTBia;
    const lenY = DDTBia;

    noc1_1.scale.set(1, 1, 1);
    let boundingBoxDay = new THREE.Box3().setFromObject(noc1_1);
    const sizeDay = new THREE.Vector3();
    boundingBoxDay.getSize(sizeDay);

    noc1_1.scale.x = lenX / sizeDay.x;
    noc1_1.scale.y = lenY / sizeDay.y;
    noc1_1.scale.z = lenZ / sizeDay.z;
  };

  const settingNoc1_2 = (noc1_2) => {
    noc1_2.position.z = (rongCot + DDTBia) * -1;
    noc1_2.position.x = truHaoGoc + DDTBia;
    noc1_2.position.y = height - DDTBia;

    const lenZ = depth - rongCot - DDTBia;
    const lenX = dayCot - truHaoGoc;
    const lenY = DDTBia;

    noc1_2.scale.set(1, 1, 1);
    let boundingBoxDay = new THREE.Box3().setFromObject(noc1_2);
    const sizeDay = new THREE.Vector3();
    boundingBoxDay.getSize(sizeDay);

    noc1_2.scale.x = lenX / sizeDay.x;
    noc1_2.scale.y = lenY / sizeDay.y;
    noc1_2.scale.z = lenZ / sizeDay.z;
  };

  const settingNoc2 = (noc2) => {
    noc2.position.z = (depth + 2 * DDTBia + truHaoGoc) * -1;
  ...
  const settingChanTruoc1 = (cTruoc1) => {
    ...
    cTruoc1.position.x = truHaoGoc + DDTBia;
  ...
  const settingChanTruoc2 = (cTruoc2) => {
    cTruoc2.position.z = (depth + 2 * DDTBia + truHaoGoc) * -1;
  ...
  const settingChanSau2 = (cSau2) => {
    cSau2.position.z = (depth + 2 * DDTBia + truHaoGoc) * -1;
  ...
  const settingXanNgang2 = (xNgang2) => {
    ...
    xNgang2.position.y = (height - caoChan) / 2 + caoChan;
  ...
  useEffect(() => {
    ...
    glftLoader.load('/glb/TADGL2-FULL-KC.glb', (gltfScene) => {
  ...
  useEffect(() => {
    if (display && gltfUuid) {
      ...
      const noc1_1 = md.getObjectByName('NOC-1-1');
      const noc1_2 = md.getObjectByName('NOC-1-2');
      ...
      const xNgang1_1_1 = md.getObjectByName('XAN-NGANG-1-1-1');
      const xNgang1_1_2 = md.getObjectByName('XAN-NGANG-1-1-2');
      ...
      noc1_1 && settingNoc1_1(noc1_1);
      noc1_2 && settingNoc1_2(noc1_2);
