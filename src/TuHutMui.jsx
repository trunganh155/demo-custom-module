...
function App2() {
  ...
  const [caoChan, setCaoChan] = useState(0.175);
  ...
  const [caoMHM, setCaoMHM] = useState(0.175);
  ...
  const settingBiaTrai = (biaTrai) => {
    ...
    biaTrai.position.y = caoMHM;

    const lenZ = DDTBia;

    const lenX = depth - DDTHau;

    const lenY = height - caoMHM - DDTBia;
  ...
  const settingOngKhoi1 = (ongKhoi1) => {
    ...
    ongKhoi1.position.y = caoMHM + DDTBia;

    const lenZ = DDTBia;

    const lenX = sizeOKhoi;

    const lenY = height - caoMHM - 2 * DDTBia;
  ...
  const settingOngKhoi2 = (ongKhoi2) => {
    ...
    ongKhoi2.position.y = caoMHM + DDTBia;
  ...
  const settingOngKhoi3 = (ongKhoi3) => {
    ...
    ongKhoi3.position.y = caoMHM + DDTBia;
  ...
  const settingChan = (chan) => {
    ...
    chan.position.y = 0.03;

    const lenZ = width;

    const lenX = DDTBia;

    const lenY = caoMHM - 0.03;
