...
function App3() {
  ...
  const settingNoc2 = (noc2) => {
    noc2.position.z = (truHaoGoc + DDTBia) * -1;
    noc2.position.x = truHaoGoc + DDTBia;
  ...
  const settingChanSau1 = (cSau1) => {
    ...
    cSau1.position.x = 0.15;
    cSau1.position.y = 0;

    const lenZ = DDTBia;
    const lenX = rongK1 - DDTBia - 0.15;
    const lenY = caoChan;
  ...
  const settingChanSau2 = (cSau2) => {
    cSau2.position.z = (0.15 + DDTBia) * -1;
    cSau2.position.x = 0.15;
    cSau2.position.y = 0;

    const lenZ = rongK2 - 2 * DDTBia - 0.15;
    const lenX = DDTBia;
    const lenY = caoChan;
  ...
  const settingXanNgang1_1 = (xNgang1_1) => {
    xNgang1_1.position.z = (DDTHau + truHaoGoc) * -1;
    xNgang1_1.position.x = depth;
    xNgang1_1.position.y = caoChan + DDTBia + 0.35;
  ...
  const settingXanNgang2_1 = (xNgang2_1) => {
    xNgang2_1.position.z = (truHaoGoc + DDTHau) * -1;
    xNgang2_1.position.x = truHaoGoc + DDTHau;
    xNgang2_1.position.y = caoChan + DDTBia + 0.35;
  ...
  const settingXanNgang1_2 = (xNgang1_2) => {
    xNgang1_2.position.z = (DDTHau + truHaoGoc) * -1;
    xNgang1_2.position.x = depth;
    xNgang1_2.position.y = caoChan + 2 * DDTBia + 0.7;
  ...
  const settingXanNgang2_2 = (xNgang2_2) => {
    xNgang2_2.position.z = (truHaoGoc + DDTHau) * -1;
    xNgang2_2.position.x = truHaoGoc + DDTHau;
    xNgang2_2.position.y = caoChan + 2 * DDTBia + 0.7;
  ...
  useEffect(() => {
    ...
    glftLoader.load('/glb/TADGL3-FULL.glb', (gltfScene) => {
