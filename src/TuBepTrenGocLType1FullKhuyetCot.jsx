...
function App3() {
  ...
  const settingXanNgang2_1 = (xNgang2_1) => {
    ...
    xNgang2_1.position.x = dayCot + truHaoGoc + DDTBia;
    xNgang2_1.position.y = height / 2;
  ...
  const settingXanNgang2_2 = (xNgang2_2) => {
    xNgang2_2.position.z = (rongCot + truHaoGoc + DDTBia) * -1;
    xNgang2_2.position.x = DDTHau;
    xNgang2_2.position.y = height / 2;

    const lenZ = rongK2 - rongCot - truHaoGoc - 2 * DDTBia;
    const lenX = depth - DDTHau;
    const lenY = DDTBia;
  ...
  useEffect(() => {
    ...
    glftLoader.load('/glb/TBTGL1KC-FULL-UV.glb', (gltfScene) => {
  ...
  useEffect(() => {
    if (display && gltfUuid) {
      ...
      const day2_1 = md.getObjectByName('G-DAY-2-1');
      const day2_2 = md.getObjectByName('G-DAY-2-2');
      const hau1 = md.getObjectByName('G-HAU-1');
      const hau2 = md.getObjectByName('G-HAU-2');
      const noc1 = md.getObjectByName('G-NOC-1');
      const noc2_1 = md.getObjectByName('G-NOC-2-1');
      const noc2_2 = md.getObjectByName('G-NOC-2-2');
      ...
      const xanNgang1 = md.getObjectByName('G-XAN-NGANG-1');
      const xanNgang2_1 = md.getObjectByName('G-XAN-NGANG-2-1');
      const xanNgang2_2 = md.getObjectByName('G-XAN-NGANG-2-2');
