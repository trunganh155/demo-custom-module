...
function App3() {
  ...
  const settingDay2 = (day2) => {
    day2.position.z = (depth + DDTBia) * -1;
  ...
  const settingHau1 = (hau1) => {
    hau1.position.z = 0 * -1;
    hau1.position.x = dayCot + truHaoGoc;
    hau1.position.y = 0;

    const lenZ = DDTHau;
    const lenX = rongK1 - dayCot - truHaoGoc;
    const lenY = height;
  ...
  const settingNoc1_1 = (day1_1) => {
    day1_1.position.z = DDTHau * -1;
    day1_1.position.x = dayCot + truHaoGoc;
    day1_1.position.y = height - DDTBia;
  ...
  const settingNoc1_2 = (day1_2) => {
    day1_2.position.z = (rongCot + truHaoGoc) * -1;
    day1_2.position.x = truHaoGoc;
    day1_2.position.y = height - DDTBia;

    const lenZ = depth - rongCot - truHaoGoc;
    const lenX = dayCot;
    const lenY = DDTBia;
  ...
  const settingNoc2 = (noc2) => {
    noc2.position.z = (depth + DDTBia + truHaoGoc) * -1;
  ...
  const settingBia2 = (bia2) => {
    bia2.position.z = (rongCot + truHaoGoc + DDTBia) * -1;
  ...
  const settingBiaCot1 = (biaCot1) => {
    ...
    const lenZ = rongCot + truHaoGoc - DDTHau;
    const lenX = DDTBia;
  ...
  const settingXan = (xan) => {
    xan.position.z = (depth - 0.08) * -1;
    xan.position.x = depth + DDTBia + truHaoGoc - 0.008;
  ...
  useEffect(() => {
    ...
    glftLoader.load('/glb/TBTGL2KC-FULL-UV.glb', (gltfScene) => {
  ...
  useEffect(() => {
    if (display && gltfUuid) {
      ...
      const day1_1 = md.getObjectByName('G-DAY-1-1');
      const day1_2 = md.getObjectByName('G-DAY-1-2');
      const day2 = md.getObjectByName('G-DAY-2');
      const hau1 = md.getObjectByName('G-HAU-1');
      const hau2 = md.getObjectByName('G-HAU-2');
      const noc1_1 = md.getObjectByName('G-NOC-1-1');
      const noc1_2 = md.getObjectByName('G-NOC-1-2');
      ...
      const biaCot1 = md.getObjectByName('G-BIA-COT-1');
      const biaCot2 = md.getObjectByName('G-BIA-COT-2');

      const ba = md.getObjectByName('G-BA');
      const xan = md.getObjectByName('G-XAN');
      const matCoDinh = md.getObjectByName('G-MAT-CO-DINH');

      const xNgang1_1 = md.getObjectByName('G-XAN-NGANG-1-1');
      const xNgang1_2 = md.getObjectByName('G-XAN-NGANG-1-2');
      const xNgang2 = md.getObjectByName('G-XAN-NGANG-2');
