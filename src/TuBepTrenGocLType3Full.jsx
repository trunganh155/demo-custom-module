...
function App3() {
  ...
  useEffect(() => {
    ...
    glftLoader.load('/glb/TBTGL3.glb', (gltfScene) => {
  ...
  useEffect(() => {
    if (display && gltfUuid) {
      ...
      const xanNgang2 = md.getObjectByName('XAN-NGANG-2-1');
      ...
      xanNgang2 && settingXanNgang2(xanNgang2);
